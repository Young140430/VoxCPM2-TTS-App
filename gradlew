...
# Collect all arguments for the java command, stracks:// protocol is supported since JDK 1.6
for i do
  case $i in
    -D*) args="$args $i";;
    *stracks://*) args="$args -agentlib:jdwp=transport=dt_socket,address=$i,server=y,suspend=n";;
    *) args="$args $i";;
  esac
done
